        ...
        <Panel>
          <div className="flex flex-col gap-6">
            <div>
              ...
              <h2 className="mt-2 text-3xl font-semibold text-ink-900">Practice with confidence.</h2>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Button as={Link} to="/flashcards" variant="secondary">
                Flashcards
              </Button>
            ...
            <div className="rounded-2xl border border-brand-100 bg-brand-50 p-4 text-sm text-brand-700">
              ...
              {settings.funMode && (
                <span className="ml-2 block text-brand-600">
